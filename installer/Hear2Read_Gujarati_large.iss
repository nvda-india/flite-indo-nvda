...
OutputBaseFilename=Hear2Read_Gujarati_Male_Voice_Large
SetupIconFile=Icon\h2r-32x32-win.ico
Compression=lzma
SolidCompression=yes
LicenseFile=Windows_Voice_Installer_License_exceptTDIL.txt
...
[Files]
Source: Languages\cmu_indic_amb_guj1000.flitevox; DestDir: {app}\Languages
...
root: HKLM; Subkey: "SOFTWARE\Microsoft\SPEECH\Voices\Tokens\Gujarati_amb"; ValueType: string; ValueName: "voxdir"; ValueData:{app}\Languages\cmu_indic_amb_guj1000.flitevox; Flags: uninsdeletekey;
